...
let avisoDistancia = (distancia) => {
    if (distancia < 20) {
        ...
        return `<h1 class="mensajes">Manten los ojos abiertos, esta muy cerca! <span>&#160</span></h1>`
    } else if (distancia < 100) {
        return `<h1 class="mensajes">Se cauteloso, puede que este cerca!<span>&#160</span></h1>`
    } else if (distancia < 200) {
        return `<h1 class="mensajes">Continua! no estas tan lejos!<span>&#160</span></h1>`
    } else if (distancia < 360) {
        return `<h1 class="mensajes">Aun estas lejos del objetivo!<span>&#160</span></h1>`
    } else {
        return `<h1 class="mensajes">Te encuentras demaciado alejado!<span>&#160</span></h1>`
    }
}